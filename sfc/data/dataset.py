...
from sfc.structures.bounding_box import BoxList
from sfc.data.augmentation import Augmentation
...
class TrkDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # target = BoxList(search_box, search_image.shape[:2], mode='xywh').convert('xyxy')
        ...
        target = BoxList([bbox.x1, bbox.y1, bbox.x2, bbox.y2], search.shape[:2], mode='xyxy')
        target.add_field('labels', neg and 0 or 1)
        # get labels
